...
from .city_timer_algorithm import CityTimerAlgorithm


class CityTimerProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(CityTimerAlgorithm())
